...
import { setField, saveNote, setAllFieldsNote, resetForm } from '../actions/NewDeputadoFormActions';
...
class NewNoteScreen extends React.Component {
  ...
  componentDidMount() {
    ...
    const { navigation, setAllFieldsNote, resetForm } = this.props;
    const { params } = navigation.state;

    if (params && params.noteToEdit) {
      setAllFieldsNote(params.noteToEdit)
    } else {
      resetForm();
    }
  }
